  ...
  return (
    <>
      ...
      <p className="subheaderContent">
        ...
        Below is a timeline of my life starting with my freshman year of high school.
      </p>
      <p className="subheaderFootnote" >
        *For a more succinct summary of my experience as a devloper, hit the "Resume" button in the top right corner.
      </p>
      <br></br> <br></br> <br></br>
      <div class="timeline">
      <div class="timelineContainer left">
          <div class="timelineContent">
            <h2>Aug 2016 - June 2017</h2>
            <h5>Portola Valley, CA</h5>
            <p> Priory Freshman year.
            </p>
          </div>
        </div>
      <div class="timelineContainer right">
          <div class="timelineContent">
            <h2>Aug 2017 - June 2018</h2>
            <h5>Bend, OR</h5>
            <p> Bend Sophmore year.
            </p>
          </div>
        </div>
        <div class="timelineContainer left">
          <div class="timelineContent">
            <h2>June - Aug 2018</h2>
            <h5>Bend, OR</h5>
            <p> Summer Camp Counselor Bend Science Station
            </p>
          </div>
        </div>
        <div class="timelineContainer right">
          <div class="timelineContent">
            <h2>Aug 2018 - June 2019</h2>
            <h5>Los Altos, CA</h5>
            <p> High school number 3! I transfer to Los Altos High School for my Junior year.
            </p>
          </div>
        </div>
      <div class="timelineContainer left">
          <div class="timelineContent">
            ...
            <p> Wikimedia Foundation Internship
            </p>
          </div>
        </div>
        <div class="timelineContainer right">
